...
const DeleteLocationModal: React.FC<DeleteLocationModalProps> = ({isOpen, onConfirmDelete, onCancelDelete, locationName}) => {
    return (
        <>
        {isOpen && (
            <Modal
                ...
                contentLabel="Remove existing Location">            
                <h2 className="text-lg font-semibold mb-4">Remove location: {locationName}?</h2>
